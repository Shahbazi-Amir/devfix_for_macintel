...
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && grep -q '^SERVER=127.0.0.1
...
grep -q 'Tor runtime: MISSING' "$CASE/doctor.out" || fail "doctor Tor evidence"; pass "doctor failure classification"
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && grep -q '^PORT=29150
proxy_is_restored() { grep -q '^ENABLED=No$' "$FAKE_PROXY_STATE_FILE" && grep -q '^SERVER=old.invalid$' "$FAKE_PROXY_STATE_FILE" && grep -q '^PORT=1080$' "$FAKE_PROXY_STATE_FILE"; }
...
grep -q 'Tor runtime: MISSING' "$CASE/doctor.out" || fail "doctor Tor evidence"; pass "doctor failure classification"
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && grep -Fxq '*.ir' "$FAKE_PROXY_BYPASS_FILE" && grep -Fxq '10.0.0.0/8' "$FAKE_PROXY_BYPASS_FILE"; }
proxy_is_restored() { grep -q '^ENABLED=No$' "$FAKE_PROXY_STATE_FILE" && grep -q '^SERVER=old.invalid$' "$FAKE_PROXY_STATE_FILE" && grep -q '^PORT=1080$' "$FAKE_PROXY_STATE_FILE"; }
...
grep -q 'Tor runtime: MISSING' "$CASE/doctor.out" || fail "doctor Tor evidence"; pass "doctor failure classification"
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && grep -q '^SERVER=old.invalid
...
grep -q 'Tor runtime: MISSING' "$CASE/doctor.out" || fail "doctor Tor evidence"; pass "doctor failure classification"
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && grep -q '^PORT=1080
...
grep -q 'Tor runtime: MISSING' "$CASE/doctor.out" || fail "doctor Tor evidence"; pass "doctor failure classification"
printf '%s\n' 'ALL DEVFIX TUNNEL SYSTEM-PROXY TESTS PASSED'
 "$FAKE_PROXY_STATE_FILE" && [ "$(cat "$FAKE_PROXY_BYPASS_FILE")" = "old.internal" ]; }
